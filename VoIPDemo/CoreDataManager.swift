...
public struct CoreDataEntity {
    private init(){}
    static let  kEntity_Notifications = "Notifications"
}

@objcMembers class CoreDataManager {
    private init() {}
    static let DBName = "VoIPDemo"
    ...
    func getObjectsforEntity(strEntity : String, ShortBy :String , isAscending : Bool ,predicate : NSPredicate! ,groupBy : NSString ) -> AnyObject {
